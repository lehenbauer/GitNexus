...
/**
 * Assert AGENTS.md contains generated skill references and CLAUDE.md imports AGENTS.md.
...
`,
   ...
   * AGENTS.md still references generated skills, and CLAUDE.md imports AGENTS.md.
   */
  it('second analyze --skills produces stable output', () => {
    ...
    /* CLAUDE.md should still import AGENTS.md without duplicating generated skills */
    const claudePath = path.join(tmpDir, 'CLAUDE.md');
    expect(fs.existsSync(claudePath)).toBe(true);
    const claudeContent = fs.readFileSync(claudePath, 'utf-8');
    expect(claudeContent).toContain('@AGENTS.md');
